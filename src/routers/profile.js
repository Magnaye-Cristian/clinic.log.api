...
profileRouter.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(req.body);
                return [4 /*yield*/, validation_schemas_1.ValidationSchemas.accountCreation.validateAsync(req.body)];
            case 1:
                result = _a.sent();
                console.log(result);
                res.send("profile1");
